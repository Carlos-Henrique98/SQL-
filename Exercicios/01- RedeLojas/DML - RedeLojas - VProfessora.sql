...
INSERT INTO TipoTransacao VALUES (1,N'Ordem de Compra')
INSERT INTO TipoTransacao VALUES (2, N'Gerenciamento de armazenagem')
INSERT INTO TipoTransacao VALUES (3, N'Ordem de Venda')

INSERT INTO Armazem VALUES ( 1, 'Central Warehouse')
INSERT INTO Armazem VALUES ( 2, 'Volka Waherouse')

INSERT INTO Prestador VALUES (1, 'MJOK petroleum')
INSERT INTO Prestador VALUES (2, 'Kazan Bosh Center')
INSERT INTO Prestador VALUES (3, 'Denso Corporation')
INSERT INTO Prestador VALUES (4, 'Castrol Corporation')

--Inserir Loja1 e Loja2 na tabela
INSERT INTO Prestador VALUES (5, 'Loja1')
INSERT INTO Prestador VALUES (6, 'Loja2')

--Add nova coluna da tabela Categoria
ALTER TABLE Categoria
ADD descricao NVARCHAR(100)

--Excluir resgistros que tenham a palavra Kazan
DELETE FROM Prestador
WHERE nome LIKE 'Kazan%'




INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (1, 1, 3, NULL, NULL, 2, CAST(N'2019-08-18' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (2, 1, 4, NULL, NULL, 1, CAST(N'2019-08-18' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (3, 1, 4, NULL, NULL, 1, CAST(N'2019-08-18' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (4, 1, 3, NULL, NULL, 2, CAST(N'2019-08-18' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (5, 1, 3, NULL, NULL, 2, CAST(N'2019-08-18' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (6, 1, 2, NULL, NULL, 2, CAST(N'2019-08-18' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (7, 1, 3, NULL, NULL, 1, CAST(N'2019-08-18' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (8, 1, 2, NULL, NULL, 1, CAST(N'2019-08-22' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (9, 1, 3, NULL, NULL, 2, CAST(N'2019-08-22' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (10, 1, 4, NULL, NULL, 2, CAST(N'2019-08-22' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (11, 1, 3, NULL, NULL, 1, CAST(N'2019-08-23' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (12, 1, 4, NULL, NULL, 2, CAST(N'2019-08-23' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (13, 1, 2, NULL, NULL, 2, CAST(N'2019-08-23' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (14, 1, 3, NULL, NULL, 2, CAST(N'2019-08-23' AS Date), NULL)
GO
INSERT Pedido ([ID], [tipoTransacaoID], [transportadoraID], [lojaID], [armazemOrigemID], [armazemDestinoID], [dataPedido], [dataEntrega]) VALUES (15, 1, 2, NULL, NULL, 2, CAST(N'2019-08-23' AS Date), NULL)
GO

CREATE DATABASE Exerc_Funcionario;

USE Exerc_Funcionario;
...
--TRAGEM OS FUNCIONARIOS QUE TRABALHAM NO DEPARTAMENTO DE FILME OU NO DEPARTAMENTO DE ROUPAS
SELECT NOME, DEPARTAMENTO FROM Funcionarios
WHERE Departamento = 'Roupas' OR Departamento = 'Filmes';

--TRAGA OS FUNCIONARIOS DO SEXO MASCULINO OU OS FUNCIONARIOS QUE TRABALHAM NO JARDIM
SELECT Nome, Sexo FROM Funcionarios
WHERE Sexo = 'Masculino' OR Departamento = 'Jardim';

--O GESTOR DE MARKETING PEDIU A LISTA DOS FUNCIONARIOS QUE TRABALHAM NO DEPARTAMENTO DE FILMES
--OU NO DEPARTAMENTO LAR. ELE NECESSITA ENVIAR UM EMAIL PARA AS COLABORADORAS DESSES DOIS SETORES
SELECT COUNT(*) as QtdProdutos, Departamento FROM Funcionarios
